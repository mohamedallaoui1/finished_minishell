...
/*   Updated: 2023/04/14 03:47:48 by mallaoui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_attr(void)
{
	tcgetattr(STDIN_FILENO, &g_glob.old_attr);
	tcgetattr(STDIN_FILENO, &g_glob.new_attr);
	tcgetattr(STDIN_FILENO, &g_glob.reset_attr);
	g_glob.old_attr.c_lflag &= ~(ECHOCTL);
}
