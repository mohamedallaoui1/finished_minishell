...
fill_struct.c string_handling.c Parsing/errors/checkerror.c Parsing/errors/utils.c Parsing/errors/utils1.c ft_free.c  Parsing/fill_struct/fiil_stract2.c Parsing/fill_struct/utils.c Parsing/fill_struct/utils1.c wildcard.c line/get_next_line.c\
...
builtin/ft_export2.c builtin/utils.c ft_ambiguous.c Execution/execute1.c Execution/utils1.c Execution/open_files.c Execution/utils3.c hereutlis.c\
